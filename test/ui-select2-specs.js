  ...
  describe( 'with a <select> element', function() {
    ...
    describe( 'when model is changed programmatically', function() {
      it( 'should set select2 to the value', function() {
        ...
        scope.foo = 'First';
        var element = compile( '<div><select cs-select2 ng-model="foo" ng-options="a for a in opts" ></select></div>' );
      ...
      it( 'should set select2 to the value for multiples', function() {
        ...
        scope.foo = ['First'];
        var element = compile( '<div><select cs-select2 multiple ng-model="foo" ng-options="a for a in opts"></select></div>' );
        scope.$apply();
    ...
    xit( 'should observe the disabled attribute', function() {
      var element = compile( '<select cs-select2 ng-model="foo" ng-disabled="disabled"></select>' );
    ...
    describe( 'when model is changed programmatically', function() {
      ...
      describe( 'for multi-select', function() {
        it( 'should call select2(data, ...) for arrays', function() {
          var element = compile( '<div><input ng-model="foo" multiple cs-select2="options"></div>' );
          spyOn( $.fn, 'select2' );
        ...
        xit( 'should call select2(val, ...) for strings', function() {
          var element = compile( '<input ng-model="foo" multiple cs-select2="options">' );
          spyOn( $.fn, 'select2' );
